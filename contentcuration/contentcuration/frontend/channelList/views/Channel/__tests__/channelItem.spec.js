...
describe('channelItem', () => {
  ...
  it('clicking delete button in dialog should delete the channel', async () => {
    deleteStub.mockResolvedValue();
    await wrapper.setData({ deleteDialog: true });
    wrapper.findComponent('[data-test="delete-modal"]').vm.$emit('submit');
